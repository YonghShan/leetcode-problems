...
+ 「单调队列优化」
  ...
  **如果能够在转移 $f[c]$ 时，以 $\mathcal{O}(1)$ 或者均摊 $\mathcal{O}(1)$ 的复杂度从「能够参与转移的状态」中（即窗口中）找到最大值，就能省掉朴素「多重背包」解决方案中最内层的“决策”循环，从而将整体复杂度降低到 $\mathcal{O}(N*C)$。**
  ...
  ==**补充：**== 这种根据“取余”对状态做划分，然后转换为「滑动窗口」问题，配合某种数据结构（单调队列/哈希表）来实现优化的方式，早就出现在各种题目中了。例如 [30. 串联所有单词的子串](https://mp.weixin.qq.com/s?__biz=MzU4NDE3MTEyMA==&mid=2247486522&idx=1&sn=81421abe8fdf606d3f6deec1709b1774&chksm=fd9ca725caeb2e335f0e861fd88b4e9e0aba919fbcf605536e3a14c0da5a3ae4e14819d16970&token=1821593597&lang=zh_CN&scene=21#wechat_redirect)、1787. 使所有区间的异或结果为零 ... 
